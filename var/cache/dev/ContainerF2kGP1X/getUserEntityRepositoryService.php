...
// Returns the private 'App\Repository\UserEntityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserEntityRepository.php';

return $this->privates['App\Repository\UserEntityRepository'] = new \App\Repository\UserEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
