...
// Returns the private 'App\Repository\CategoryEntityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CategoryEntityRepository.php';

return $this->privates['App\Repository\CategoryEntityRepository'] = new \App\Repository\CategoryEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
