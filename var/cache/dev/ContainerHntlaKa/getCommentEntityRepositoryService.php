...
// Returns the private 'App\Repository\CommentEntityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommentEntityRepository.php';

return $this->privates['App\Repository\CommentEntityRepository'] = new \App\Repository\CommentEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
