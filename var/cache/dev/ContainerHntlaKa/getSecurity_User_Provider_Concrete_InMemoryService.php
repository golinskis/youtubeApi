...
return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('szym' => array('password' => 'szym123', 'roles' => array(0 => 'ROLE_ADMIN'))));
