...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategoryEntityRepository' => function () {
    return ($this->privates['App\Repository\CategoryEntityRepository'] ?? $this->load('getCategoryEntityRepositoryService.php'));
}, 'App\\Repository\\CommentEntityRepository' => function () {
    return ($this->privates['App\Repository\CommentEntityRepository'] ?? $this->load('getCommentEntityRepositoryService.php'));
}, 'App\\Repository\\FilmEntityRepository' => function () {
    return ($this->privates['App\Repository\FilmEntityRepository'] ?? $this->load('getFilmEntityRepositoryService.php'));
}, 'App\\Repository\\UserEntityRepository' => function () {
    return ($this->privates['App\Repository\UserEntityRepository'] ?? $this->load('getUserEntityRepositoryService.php'));
}))));
