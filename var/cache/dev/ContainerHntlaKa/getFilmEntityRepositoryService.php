...
// Returns the private 'App\Repository\FilmEntityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FilmEntityRepository.php';

return $this->privates['App\Repository\FilmEntityRepository'] = new \App\Repository\FilmEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
